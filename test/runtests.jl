...
@time include("linalg.jl")        #  27  17  22  22  62  24  14  22   7  28  33  19
...
@time include("reduction.jl")     #  71  37  52  55 106  40  21  29  11  57  55  29
@time include("conv.jl")          #  70  33  48  51 107  22  12  62  47  26  44  16
@time include("rnn.jl")           # err  52  54  41  81                  12
