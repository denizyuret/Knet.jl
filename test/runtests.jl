#                            commit 73c c6a 0b5 e3a 9.2 8.3 8.3 6cb 6cb 8.6 6cb 6cb
...
@time include("distributions.jl") #   2   1   1   1   2   1   1   2   1   3   3   2
...
@time include("reduction.jl")     #  80  37  52  55 106  40  21  29  11  57  55  29
@time include("linalg.jl")        #  90  17  22  22  62  24  14  22   7  28  33  19
@time include("conv.jl")          #  93  33  48  51 107  22  12  62  47  26  44  16
@time include("rnn.jl")           # 142  52  54  41  81                  12
@time include("binary.jl")        # 165  64  75  80  56  34  19 491 119  51  53  25
@time include("unary.jl")         # 217  86 103 103 122  42   6  36   4  56  67  11
@time include("update.jl")        # 225  61  82  60  61  29  26 100  22  72  25  23
