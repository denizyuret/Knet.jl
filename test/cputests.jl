...
@test  LinReg.main("") == (0.0005439055920768844,32.772149551563935,0.11210599283551381)

include(Pkg.dir("Knet/examples/mnist2d.jl"))
#@test MNIST2D.main("--epochs 1") == (0.3204898f0, 32.93997f0, 4.614684f0) #gpu
@test  MNIST2D.main("--epochs 1") == (0.30533937f0,33.110886f0,5.677294f0)

#@test MNIST2D.main("--epochs 1 --ysparse") == (0.3204898f0, 32.93997f0, 4.614684f0) #gpu
@test  MNIST2D.main("--epochs 1 --ysparse") == (0.30533937f0,33.110886f0,5.677294f0)
