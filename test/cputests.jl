...
include(joinpath("..","examples","linreg.jl"))
...
# Do not download mnist for every test.
...
# # include(joinpath("..","examples","mnist4d.jl"))
...
include(joinpath("..","examples","adding.jl"))
...
seqdata = joinpath(dirname(@__FILE__),"..","data","seqdata.txt")

include(joinpath("..","examples","rnnlm.jl"))
...
include(joinpath("..","examples","copyseq.jl"))
