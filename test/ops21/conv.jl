...
@testset "ops21/conv" begin
    ...
    function convtest(
        ...
        tol = (eltype(pw) == Float64 ? 0.05 : 0.50)
        r2 = @gcheck conv(pw,px;bias=pb,z=pz,activation,alpha,beta,channelmajor,crosscorrelation,dilation,group,padding,stride) (;rtol=tol)
        r1 && r2
    end
