...
# @date timeit(train0,w1); # => 6.713386 seconds (7.34 M allocations: 276.245 MB, 4.68% gc time) # compare to 1.977053 seconds (2.91 M allocations: 173.705 MB)  # compare to 1.8276 in Knet7
# @date timeit(train1,w1); # => 5.613988 seconds (6.75 M allocations: 258.575 MB, 4.26% gc time) # compare to 1.898212 seconds (2.88 M allocations: 173.156 MB)
# @date timeit(train2,w1); # => 1.213765 seconds (668.72 k allocations: 25.752 MB) # compare to 1.025943 seconds (631.80 k allocations: 74.277 MB)
# @date timeit(train3,w1); # => 0.464109 seconds (259.80 k allocations: 11.838 MB) # compare to 0.608363 seconds (601.80 k allocations: 27.127 MB)

# @date timeit(train0,w2); # => 11.899407 seconds (11.37 M allocations: 421.264 MB, 4.53% gc time) # compare to 3.659655 seconds (6.97 M allocations: 344.909 MB)  # compare to 2.9201 in Knet7
# @date timeit(train1,w2); # => 9.333509 seconds (10.21 M allocations: 386.199 MB, 4.29% gc time) # compare to 3.505348 seconds (6.90 M allocations: 343.810 MB)
# @date timeit(train2,w2); # => 1.874707 seconds (907.80 k allocations: 33.353 MB) # compare to 1.391519 seconds (1.36 M allocations: 107.053 MB)
# @date timeit(train3,w2); # => 0.856982 seconds (511.80 k allocations: 20.078 MB) # compare to 0.985798 seconds (1.33 M allocations: 59.903 MB)
