...
function cuda12test(fname, jname=fname, o...)
    ...
    isapprox(to_host(out32),fcpu(to_host(mat32),to_host(mat32))) || warn("$fname 32 mat mat")
    ...
    isapprox(to_host(out64),fcpu(to_host(mat64),to_host(mat64))) || warn("$fname 64 mat mat")
