...
deepcopy_internal(x::KUdense,s::IdDict)=(haskey(s,x)||(s[x]=copy(x));s[x])
cpucopy_internal(x::KUdense,s::IdDict)=deepcopy_internal(x,s)
gpucopy_internal(x::KUdense,s::IdDict)=deepcopy_internal(x,s)

cpucopy_internal{A<:CudaArray}(x::KUdense{A},s::IdDict)=(haskey(s,x)||(s[x]=KUdense(to_host(x.arr)));s[x])
gpucopy_internal{A<:Array}(x::KUdense{A},s::IdDict)=(haskey(s,x)||(s[x]=KUdense(CudaArray(x.arr)));s[x])
