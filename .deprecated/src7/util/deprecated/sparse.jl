...
cpucopy_internal{A<:CudaArray,T}(s::KUsparse{A,T},d::IdType)=
...
gpucopy_internal{A<:Array,T}(s::KUsparse{A,T},d::IdType)=
...
# cpucopy_internal{A<:CudaArray,T,I}(s::Sparse{A,T,I},d::IdType)=
#     (haskey(d,s) ? d[s] : 
...
# gpucopy_internal{A<:Array,T,I}(s::Sparse{A,T,I},d::IdType)=
#     (haskey(d,s) ? d[s] : 
...
# cpucopy_internal{A<:CudaArray,T,I}(s::KUsparse0{A,T,I},d::IdType)=
#     (haskey(d,s) ? d[s] :
...
# gpucopy_internal{A<:Array,T,I}(s::KUsparse0{A,T,I},d::IdType)=
#     (haskey(d,s) ? d[s] : 
