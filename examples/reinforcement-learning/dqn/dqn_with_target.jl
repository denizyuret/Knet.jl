...
arXiv preprint arXiv:1312.5602. It also shows the usage of a target network for
the target q value predictions.
"""
...
function main(args=ARGS)
    s = ArgParseSettings()
    s.description = "(c) Ozan Arkan Can, 2018. An implementation of the deep q network with a target network."
...
PROGRAM_FILE == "dqn_with_target.jl" && main(ARGS)
