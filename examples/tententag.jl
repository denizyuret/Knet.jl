...
sgen1=SketchEngine(`xzcat sdfkl32KCsd_enTenTen12.vert.xz`; dict="wdict10000", column=1)
sgen2=SketchEngine(`xzcat sdfkl32KCsd_enTenTen12.vert.xz`; dict="pdict58", column=2)
