...
function ipa(args=ARGS)
    ...
    @add_arg_table s begin
        ("--datafiles"; nargs='+'; required=true; help="First pair used for training")
        ...
        ("--decay"; arg_type=Float64; default=1.0)
        ("--drop1"; arg_type=Float64; default=0.4)
        ("--drop2"; arg_type=Float64; default=0.2)
        ("--fbias"; arg_type=Float64; default=0.8324)
        ("--ftype"; default="Float32")
        # ("--winit"; arg_type=Float64; default=0.15)
        ("--usesparse"; action=:store_true)
