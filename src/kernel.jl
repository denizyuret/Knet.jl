...
# if GPU
# poly(y::CudaArray{Float32}, a, b, d)=(ccall((poly32,libkunet),Void,(Ptr{Float32},Float32,Float32,Float32),y,a,b,d);y)
# poly(y::CudaArray{Float64}, a, b, d)=(ccall((poly64,libkunet),Void,(Ptr{Float64},Float64,Float64,Float64),y,a,b,d);y)
