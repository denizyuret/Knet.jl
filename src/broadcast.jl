            ...
            function $J(x::KnetArray{$T},y::KnetArray{$T})
                ...
                if size(x)==size(y)
                    ...
                    # multi dimensional broadcast
                        ...
                        if ndims(z)>11
                          println("F17 xlast:$xlast ylast:$ylast dz $dz,sx $sx,nx $nx,sy $sy,ny $ny,xdims $xdims,ydims $ydims stride_x:$stride_x stride_y:$stride_y stride_z:$stride_z length(z):$(length(z))")
                            ...
                            println("F16 xlast:$xlast ylast:$ylast dz $dz,sx $sx,nx $nx,sy $sy,ny $ny,xdims $xdims,ydims $ydims stride_x:$stride_x stride_y:$stride_y stride_z:$stride_z length(z):$(length(z))")
