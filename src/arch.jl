...
type RNN2 <: Model; net1; net2; nt; RNN2(a,b)=new(a,b,0); end
...
Base.isequal(a::RNN2,b::RNN2)=isequal(a.net1,b.net1)&&isequal(a.net2,b.net2)

### DEAD CODE:

# DONE: create a super class for RNN and RNN2, this gradcheck applies to both
...
# function train(r::RNN2,x,y; getloss=false, getnorm=false, gc=0)
#     rval = Any[]
...
# function sumnorm(r::RNN2, w=0, g=0)
#     for n=1:nops(r)
#         p = param(op(r,n))
#         p == nothing && continue
#         w += vecnorm(p.arr)
