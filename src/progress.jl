...
`00:53` is the estimated total seconds, `1137.05/s` is the average number of iterations
completed per second. The percent, total iterations, and completion time are omitted for
iterators whose size is unknown.
